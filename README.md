...
1. **Frontend:** Built with Django templates, HTML, and CSS, providing a user-friendly interface to input movie reviews.
2. **Backend:** Powered by Django, handling requests, model inference, and database interactions.
3. **Model:** An LSTM neural network built using Keras and TensorFlow, trained on IMDb reviews to classify sentiment.
4. **Database:** Used to store user inputs and results for further analysis (if needed).
...
![Screenshot 2024-07-13 143644](https://github.com/user-attachments/assets/0f1cee3d-1759-480e-8abd-09cfc6023849)
## Future Improvements
